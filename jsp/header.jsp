...
<html>
	...
	$(function(){
		var url = "/store_v5/CategoryServlet";// C AND CATEGORY REPRESENTS CATEGORY
		var obj ={"method":"getAllCats"};
		$.post(url,obj,function(data){
			//alert(data);
			$.each(data,function(i,obj){
				var li="<li> <a href='${pageContext.request.contextPath}/ProductServlet?method=getProductsByCidWithPage&num=1&cid="+obj.cid+"'>"+obj.cname+"</a></li>"
				$("#myUL").append(li);
			});
		},"json");
	});
